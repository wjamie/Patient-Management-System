 ...
 * @author Walker
 */
public class PatientViewAppointmentsGUI extends javax.swing.JFrame {
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        PatientViewAppointmentsGUI patientGiveFeedbackGUIinstance = new PatientViewAppointmentsGUI();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientViewAppointmentsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientViewAppointmentsGUI().setVisible(true);
            }
        });
    }
